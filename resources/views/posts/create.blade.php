    ...
    <div class="relative pb-32">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8 space-y-6 text-gray-100 relative">
            <div class="mt-5 relative z-10">
                <h1 class="text-4xl mb-8">First you need to create a Page</h1>
                <form action="{{ route('posts.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <section id="form-part-1">
                        <div>
                            ...
                            <input id="title" placeholder="Inser a title for your item"
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="content" placeholder="Insert a short description of your item"
                                class="block w-full mt-2 px-3 py-2 text-gray-100 outline-none border rounded-lg border-none focus:border-primary focus:ring-primary bg-white/[.075]"
                        ...
                        <div class="mt-4">
                            ...
                            <input id="image" type="file" name="image" required
                                class="block w-full mt-2 px-3 py-2 text-gray-100 outline-none border rounded-lg border-none focus:border-primary focus:ring-primary bg-white/[.075]">
                            <div class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="user_avatar_help">Insert a
                                background image for your page</div>
                        </div>
                    ...
                    <section id="form-part-2" style="display: none;">
                        ...
                        <button type="button" id="add-repeatable-field-button"
                            class="bg-primary hover:bg-gray-600 duration-150 px-4 py-2 rounded-lg flex items-center shadow-primary hover:shadow-gray-600 shadow-2xl mt-4">Add
                            Field</button>
